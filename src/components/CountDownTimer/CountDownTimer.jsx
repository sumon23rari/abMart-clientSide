...
const CountDownTimer = () => {
    ...
    return (
        <div className="bg-[#D6FEEB] rounded p-3 flex font-bold flex items-center">
        <div className='mx-2 text-center'>
              <h3 className='text-xl p-2 bg-gradient-to-r from-[#24D381] to-[#32EC95] text-white font-bold'>
                {timeRemaining.days}
              </h3>
              <span >Days</span>
            </div>
           <span className ="items-center -mt-6 text-2xl text-2xl">  :</span>
            <div className='mx-2 '>
            <h3 className='text-xl p-2 bg-gradient-to-r from-[#24D381] to-[#32EC95] text-white font-bold'>
